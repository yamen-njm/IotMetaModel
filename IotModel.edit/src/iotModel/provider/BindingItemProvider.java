...
/**
 * This is the item provider adapter for a {@link iotModel.Binding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IotModelPackage.Literals.BINDING__MEASURAND,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IotModelPackage.Literals.BINDING__NAME,
				 true,
				 false,
				 false,
	...
	protected void addFeaturesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Binding_features_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Binding_features_feature", "_UI_Binding_type"),
				 IotModelPackage.Literals.BINDING__FEATURES,
				 true,
				 false,
				 true,
				 null,
